...
class ChatRepository {
  ...
  //TODO..
  Future<String> mockGetMessageService({required String sendMessage}) async {
    //Future içerisindeki sendMessage bizim servisde yollayacağımız kullanıcının sorusu
    //gerçek api olmadığı için sendMessage ı kullanamadım.

    final AnswerApiDataControl getMessage = Get.find<AnswerApiDataControl>();
    //Future içerisindeki getMessage senin servisinden gelecek olan cevap

    try {
      await Future.delayed(const Duration(seconds: 5));
      return getMessage.answer.value = '${faker.lorem.sentences(5).join('\n')}  \nGenerated by Chatbot';
    } catch (e) {
